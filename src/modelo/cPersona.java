...
public class cPersona {
    ...
    public cPersona(){//probar instancia
    ...
    public cPersona(String nombreCompleto, LocalDate fechaNacimiento, double peso, double altura, String direccion, String telefono, String correo) {
