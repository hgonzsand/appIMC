 ...
 * @author heort
 */
public class APPIMCC {
    
    private static ArrayList<cPersona>ListaPersonas=new ArrayList();
    ...
    private static void mostrarPersonas() {
        if (ListaPersonas.isEmpty()) {
            ...
            for (cPersona persona : ListaPersonas) {//el for recorre la lista Lsita persona por medio del constructor Persona de la clase
